package com.cmcorg.service.engine.web.menu.service.impl;
...
import com.cmcorg.engine.web.auth.util.MyTreeUtil;
...
import com.cmcorg.service.engine.web.menu.exception.BizCodeEnum;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenuDO> implements SysMenuService {
    ...
    public Page<SysMenuDO> myPage(SysMenuPageDTO dto) {
        ...
        return lambdaQuery().like(StrUtil.isNotBlank(dto.getName()), SysMenuDO::getName, dto.getName())
            ...
            .orderByDesc(BaseEntityTree::getOrderNo).page(dto.getPage(true));
    }
    ...
    public List<SysMenuDO> userSelfMenuList() {
        ...
        // 获取当前用户绑定的菜单
        List<SysMenuDO> sysMenuDOList = AuthUserUtil.getMenuListByUserId(userId, 1);
