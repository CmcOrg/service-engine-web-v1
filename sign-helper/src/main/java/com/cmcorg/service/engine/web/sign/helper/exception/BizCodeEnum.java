package com.cmcorg.service.engine.web.sign.helper.exception;
...
public enum BizCodeEnum implements IBizCode {
    ...
    UNABLE_TO_SEND_VERIFICATION_CODE_BECAUSE_THE_EMAIL_ADDRESS_IS_NOT_BOUND(300111, "操作失败：您还没有绑定邮箱，无法发送验证码"), //
